...
public class WebAuthorization extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.httpBasic().and()
                ...
                .permitAll()
                .antMatchers(HttpMethod.GET, "/api/clients", "/api/accounts", "/api/cards").hasRole("ADMIN")
                .antMatchers(HttpMethod.GET, "/api/clients/current/loans", "/api/clients/current/cards", "/api/loans").hasAnyAuthority()
        ...
        http.authorizeRequests()
                ...
                .antMatchers("/rest/**", "/h2-console/**", "/web/loan-creation.html").hasAuthority("ADMIN")
